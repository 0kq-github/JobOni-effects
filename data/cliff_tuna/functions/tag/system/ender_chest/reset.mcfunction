#エンダーチェストの中身をすべてクリアする

#execute at @s run playsound entity.experience_orb.pickup master @a ~ ~ ~ 1 1 0
...
clear @s #cliff_tuna:all_items{enderchest:1b}
kill @e[type=item,nbt={Item:{tag:{enderchest:1b}}}]
